package com.hanyun.platform.ground.util.json;
...
public final class JsonUtil {
    ...
    public static <T> T fromJson(String json, com.fasterxml.jackson.core.type.TypeReference<?> typeReference) throws IOException {
